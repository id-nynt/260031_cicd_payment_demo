...
The [eight-phase manual](../docs/BDI_MANUAL_EXECUTION_GUIDE.md) starts with running verified v1. [Setup](../docs/BDI_SETUP.md) covers publication of the updated worker, authentication and isolated checks. [Policy details](../docs/BDI_GENERATION_AND_RUNTIME.md) distinguish execution retry, health observation and reconciliation. Superseded guidance is in [docs/archive/pre-policy-refactor](../docs/archive/pre-policy-refactor/README.md).
