...
At that revision, passed: 29 Python tests, 20 Java tests, 20 actual Jason scenarios using simulated adapters, and all 9 payment tests plus lint/build. Full retained evidence and scope are in [the validation record](../06_experiment-records/canonical-repair-2026-09-20/00_README.md). Those scenario source hashes identify that historical implementation.
...
The current walkthrough is [BDI_MANUAL_EXECUTION_GUIDE.md](../../execution/guidelines/03_BDI_MANUAL_EXECUTION_GUIDE.md). Payment source inspection confirms selected worker entity names, environment/port mappings, OTLP-to-Prometheus metrics, and execution identity. No live deployment is claimed by this correction.

Lifecycle correction validation: 36 Python tests, 20 Java tests and 20 simulated Jason scenarios, plus a healthy campaign using the persistent payment agent. See the [lifecycle validation record](../06_experiment-records/persistent-project-2026-09-20/00_README.md) for commands, retained evidence and live-experiment limits.
