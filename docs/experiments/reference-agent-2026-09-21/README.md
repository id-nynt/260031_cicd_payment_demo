...
No deployment, push, merge, tag movement or history rewrite was performed. The real worker mapping was inspected and existing HTTP/telemetry adapter tests were run; live credentials, runner availability and remote dispatch still require the manual experiment. See the [walkthrough](../../BDI_MANUAL_EXECUTION_GUIDE.md#optional-experiment-require-staging-to-fail).
